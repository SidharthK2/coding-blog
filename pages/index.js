  ...
  return (
    <>
      ...
      <footer class="bg-gray-100 p-2">
        <div class="pt-6 mt-3 border-t border-white/25 sm:items-center sm:justify-between sm:flex">
          <nav class="flex justify-center items-center text-sm font-medium space-x-4 sm:justify-start">
            ©
...
}
{
  ...
  <a href="https://github.com/SidharthK2">SidharthK2</a>
</p>; */
}
